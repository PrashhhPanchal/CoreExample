package com.archisys.archisyscorelib.Utils.Utils.StickyHeaders;
...
import com.archisys.stockbooknew.R;
...
public class StickyHeaderLayoutManager extends RecyclerView.LayoutManager {
	...
	private static class SavedState implements Parcelable {
		...
		public static final Creator<SavedState> CREATOR = new Creator<StickyHeaderLayoutManager.SavedState>() {
			@Override
			public StickyHeaderLayoutManager.SavedState createFromParcel(Parcel in) {
